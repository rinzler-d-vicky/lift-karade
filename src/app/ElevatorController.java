...
public class ElevatorController implements Runnable, Pausable, InputCallable{
	...
	public String toString(){
		...
		str += "\n\nCall Stack:";
		for (String call : callStack) str+="\n"+call;
		return str;
	}

	public static void SetLiftCount(int count){
		// no negetive, min 1
		String query = "UPDATE L_OPTIONS SET VALUE='" + count + "' WHERE NAME='LIFTS'";
		System.out.println(query);
	}

	public static void SetFloorCount(int count){
		// no negetive, min 1
		String query = "UPDATE L_OPTIONS SET VALUE='" + count + "' WHERE NAME='FLOORS'";
		System.out.println(query);
	}

	public static void SetCommonFloor(int floor){
		// no neg
